...
<body>
    ...
    text-break mt-5">ADENDUM AL CONTRATO DE MUTUO CON INTERESES DE FECHA <span
        ...
        <p class="text-justify text-break">I.- En fecha {{ $fecha_inicio }} “LAS PARTES” celebraron un Contrato de Mutuo
            ...
            {{ $folioPrincipal }}, en el cual, se ostentaron con el mismo carácter
        ...
        <p class="text-justify text-break">b. b. Que han llegado a un acuerdo para modificar la Cláusula 4.- del
            Contrato Principal de Mutuo con Intereses con la intención de ampliar la vigencia de este, por lo que es su
            voluntad otorgar el presente Adendum. </p>
        ...
        <p class="text-justify text-break">f. Que están de acuerdo con que la intención del presente Adendum es la de
            que el “CLIENTE” Reinvierta el Capital del Contrato Principal de Mutuo con Intereses con el “PRESTADOR”.
            .</p>
        ...
        <p class="text-justify text-break">1.- El objeto del presente Adendum es el de modificar las Cláusulas 4.- del
            ...
            {{ $folioPrincipal }} relativa al capital Objeto del Contrato. </p>
        ...
        <p class="text-justify text-break">Partiendo de lo anterior, “LAS PARTES” acuerdan que el capital Objeto del
            ...
            {{ $folioPrincipal }} es de {{ $inversion->cantidad }} ({{ $inversion->cantidad }} PESOS 00/100 M.N.).
        </p>
        <p class="text-justify text-break">3.- Para la actualización del capital Objeto del Contrato de Mutuo el
            “CLIENTE” ha entregado con antelación a la firma del presente la cantidad de
            ${{ $diferenciamayor }}
            (${{ $diferenciamayor }} PESOS 00/100 M.N.) al
            “PRESTADOR” como consta en el recibo correspondiente, y a su vez, el “PRESTADOR” tiene por recibida dicha
            cantidad.
        </p>
